...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Charitycoin Core charitycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  charitycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded charitycoin transaction") + "\n" +
                               "  charitycoin-tx [options] -create [commands]   " + _("Create hex-encoded charitycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded charitycoin transaction
