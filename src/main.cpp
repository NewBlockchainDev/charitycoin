...
#if defined(NDEBUG)
#error "CharityCoin cannot be compiled without assertions."
#endif
...
int64_t GetTotalValue(int nHeight)
{
	...
	else if (nHeight < 3000 && nHeight > 0) {
        nSubsidy = 1 * COIN;
    }
	else if (nHeight < 46200 && nHeight >= 3000) {
        nSubsidy = 2 * COIN;
    }
	else if (nHeight < 89400 && nHeight >= 46200) {
        nSubsidy = 4 * COIN;
    }
    else if (nHeight < 132600 && nHeight >= 89400) {
        nSubsidy = 6 * COIN;
    }
    else if (nHeight < 175800 && nHeight >= 132600) {
        nSubsidy = 8 * COIN;
    }
    else if (nHeight < 219000 && nHeight >= 175800) {
        nSubsidy = 10 * COIN;
    }
    else if (nHeight < 262200 && nHeight >= 219000) {
        nSubsidy = 8 * COIN;
    }
    else if (nHeight < 305400 && nHeight >= 262200) {
        nSubsidy = 6 * COIN;
    }
    else  if (nHeight >= 305400) {
        nSubsidy = 4 * COIN;
    } 
    else {
        nSubsidy = 0 * COIN;
...
int64_t GetBlockValue(int nHeight)
{
    ...
    return nSubsidy * (0.8 + 0.15);
}

int nStartTreasuryBlock = 2999 + 43200;
int nTreasuryBlockStep = 43200;
...
int64_t GetTreasuryAward(int nHeight)
{
	...
	if(IsTreasuryBlock(nHeight)) {
        //one month : 43200block, 15% - reward to PoS
        nSubsidy = 43200 * GetTotalValue(nHeight) * 0.05 + GetTotalValue(nHeight) * 0.15;
		return nSubsidy; 
	} else
		return 0;
}
...
{
    RenameThread("charitycoin-scriptch");
