...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("CharityCoinMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("CharityCoinMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running CharityCoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
