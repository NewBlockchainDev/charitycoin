...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Charitycoin features */
        {"charitycoin", "masternode", &masternode, true, true, false},
        {"charitycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"charitycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"charitycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"charitycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"charitycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"charitycoin", "startmasternode", &startmasternode, true, true, false},
        {"charitycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"charitycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"charitycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"charitycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"charitycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"charitycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"charitycoin", "mnbudget", &mnbudget, true, true, false},
        {"charitycoin", "preparebudget", &preparebudget, true, true, false},
        {"charitycoin", "submitbudget", &submitbudget, true, true, false},
        {"charitycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"charitycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"charitycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"charitycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"charitycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"charitycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"charitycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"charitycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"charitycoin", "mnsync", &mnsync, true, true, false},
        {"charitycoin", "spork", &spork, true, true, false},
        {"charitycoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"charitycoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use charitycoind, or the -server option to charitycoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> charitycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:48491/\n";
}
