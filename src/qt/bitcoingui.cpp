                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CharityCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and charitycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CharityCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CharityCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a CharityCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CharityCoin Core help message to get a list with possible CharityCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CharityCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("CharityCoin Core"); // default title
