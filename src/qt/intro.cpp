...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CharityCoin Core"),
     ...
     * override -datadir in the charitycoin.conf file in the default data directory
     * (to be consistent with charitycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
