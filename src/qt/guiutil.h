...
/** Utility functions used by the CharityCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CharityCoin addresses in monospace font
...
// Parse "charitycoin:" URI into recipient object, return true on successful parsing
