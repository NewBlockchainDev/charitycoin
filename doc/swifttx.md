...
This mechanism has been integrated into Bitcore-Node-CharityCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CharityCoin-Project/insight-api-charitycoin#web-socket-api](https://github.com/CharityCoin-Project/insight-api-charitycoin#web-socket-api) 
* API: [https://github.com/CharityCoin-Project/insight-api-charitycoin#swifttx-transactions](https://github.com/CharityCoin-Project/insight-api-charitycoin#swifttx-transactions) 
...
By default, the CharityCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CharityCoin Core daemon:
