...
In order to support loading of multiple wallets in charitycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is charitycoin.cpp.
...
Changes to charitycoin.cpp
----------------------
charitycoin.cpp is the entry point into charitycoin-qt, and as such, will require some minor modifications to provide hooks for
