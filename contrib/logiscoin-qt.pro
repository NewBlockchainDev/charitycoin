...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/charitycoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/charitycoin-cli.cpp \
           src/charitycoin-tx.cpp \
           src/charitycoin.cpp \
           src/db.cpp \
           ...
           src/qt/charitycoin.cpp \
           src/qt/charitycoinstrings.cpp \
...
RESOURCES += src/qt/charitycoin.qrc src/qt/charitycoin_locale.qrc

TRANSLATIONS += src/qt/locale/charitycoin_bg.ts \
                src/qt/locale/charitycoin_de.ts \
                src/qt/locale/charitycoin_en.ts \
                src/qt/locale/charitycoin_es.ts \
                src/qt/locale/charitycoin_fi.ts \
                src/qt/locale/charitycoin_fr.ts \
                src/qt/locale/charitycoin_it.ts \
                src/qt/locale/charitycoin_ja.ts \
                src/qt/locale/charitycoin_pl.ts \
                src/qt/locale/charitycoin_pt.ts \
                src/qt/locale/charitycoin_ru.ts \
                src/qt/locale/charitycoin_sk.ts \
                src/qt/locale/charitycoin_sv.ts \
                src/qt/locale/charitycoin_vi.ts \
                src/qt/locale/charitycoin_zh_CN.ts \
                src/qt/locale/charitycoin_zh_TW.ts
